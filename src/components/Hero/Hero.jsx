    ...
    <div className="relative overflow-hidden bg-gray-100 flex justify-center items-center dark:bg-gray-950 dark:text-white duration-200">
      ...
      <div className="w-full relative">
        ...
        <div className="absolute top-0 left-0 w-full h-full flex flex-col justify-center items-center sm:items-start text-center sm:text-left bg-black bg-opacity-50 text-white p-10">
          ...
          <p className="text-lg sm:text-2xl font-light text-yellow-600 italic w-full sm:w-2/4 mb-6">
          ...
          <div className="flex flex-wrap justify-center sm:justify-start space-x-4">
            <Link to="/donation">
              <button
                ...
                className="bg-gradient-to-r from-red-800 to-secondary hover:scale-105 duration-200 text-white py-3 px-8 sm:py-4 sm:px-10 mb-4 sm:mb-0 mr-0 sm:mr-4"
              >
                Donate
              </button>
            </Link>
            <Link to="/contact">
              <button
                onClick={handleOrderPopup}
                className="bg-gradient-to-r from-red-800 to-secondary hover:scale-105 duration-200 text-white py-3 px-8 sm:py-4 sm:px-10"
              >
                Contact Us
              </button>
            </Link>
