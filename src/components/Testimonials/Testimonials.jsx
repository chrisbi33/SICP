...
const TestimonialData = [
  ...
  
  {
    ...
    text: "Participating in SICP's programs has been a privilege. The organization's work in supporting vulnerable groups in Kigali is essential and makes a real difference. Thanks for this huge initiative.",
...
const Testimonials = () => {
  ...
  return (
    ...
    <div className="py-10 mb-10" style={{
      backgroundImage:
      ...
      <div className="container">
        ...
        <div className="text-center mb-10 max-w-[600px] mx-auto -mt-8">
          ...
          <h1 data-aos="fade-up" className="w-full text-3xl font-bold text-red-800 text-center">
            What Our Donors Say
          </h1>
          <p data-aos="fade-up" className="text-gray-700 font-extralight mt-5">
          ...
          <Slider {...settings}>
            {TestimonialData.map((data) => (
              <div className="my-6">
                <div
                  key={data.id}
                  className="flex flex-col gap-4  py-8 px-6 mx-4  shadow-lg rounded-xl bg-gradient-to-r from-pink-500 to-red-950 relative"
                >
                  <div className="mb-4">
                    <img
                      src={data.img}
                  ...
                  <div className="flex flex-col items-center gap-4">
                    <div className="space-y-3">
                      <p className="text-xs text-white to-gray-500">
                        {data.text}
                      </p>
